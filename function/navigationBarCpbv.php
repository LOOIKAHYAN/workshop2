...
<head>
    ...
    <title>Navigation Bar CPBV</title>
    <?php 
    include "favicon.php"; 
    ?>
...
<nav>
    ...
    <ul>
        <li><a href="http://localhost/workshop2/adminLogin/successLoginCpbv.php">Main</a></li>
        <li><a href="http://localhost/workshop2/adminLogin/cpbvProfile.php">Profile</a></li>
