...
<head>
    ...
    <title>Navigation Bar KKM</title>
    <?php 
    include "favicon.php"; 
    ?>
...
<nav>
    ...
    <ul>
        <li><a href="http://localhost/workshop2/adminLogin/successLoginKkm.php">Main</a></li>
        <li><a href="http://localhost/workshop2/adminLogin/kkmProfile.php">Profile</a></li>
