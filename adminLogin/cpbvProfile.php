...
<tr>
	<th colspan="2" style="text-align: center;"><img class="userlogo" src="../image/CPBV.png"></th>
</tr>
...
<?php 
	...
	if($total != 0){
		while($result=mysqli_fetch_assoc($data)){
			...
			echo"
		<tr>
			<td><a href='updateCpbvProfile.php?adminid=$result[adminid]&adminname=$result[adminname]&password=$result[password]&roleid=$result[roleid]'><input type='submit' value='Update Profile' class='updateBtn'></td>
			<td></td>
	</tr>
	";
		}
