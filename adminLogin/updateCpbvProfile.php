...
<html>
<head>
<title>Update CPBV Profile</title>
	<?php
...
if($data){
	echo "<script>alert('CPBV Profile Updated')</script>";
	?>
	<META HTTP-EQUIV="Refresh" CONTENT="0; URL=http://localhost/workshop2/adminLogin/cpbvProfile.php">
	<?php
}

else{
	echo "<script>alert('Failed to update CPBV profile')</script>";
	?>
	<META HTTP-EQUIV="Refresh" CONTENT="0; URL=http://localhost/workshop2/adminLogin/cpbvProfile.php">
	<?php
}
